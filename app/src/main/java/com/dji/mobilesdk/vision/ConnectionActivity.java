...
public class ConnectionActivity extends Activity implements View.OnClickListener {
                ...
                public void run() {
                    DJISDKManager.getInstance().registerApp(ConnectionActivity.this.getApplicationContext(), new DJISDKManager.SDKManagerCallback() {
                        ...
                        public void onProductConnect(BaseProduct baseProduct) {
                            ...
                            isRegistrationInProgress.set(false);
                            if (baseProduct != null) {
                                DJIVisionApplication.updateProduct(baseProduct);
                            }
                        }
                        @Override
    ...
    private void updateTitleBar() {
        boolean ret = false;
        BaseProduct product = DJIVisionApplication.getProductInstance();
        if (product != null) {
            if (product.isConnected()) {
                //The product is connected
                showToast(DJIVisionApplication.getProductInstance().getModel() + " Connected");
                ret = true;
            } else {
    ...
    private void updateVersion() {
        ...
        if (DJIVisionApplication.getProductInstance() != null) {
            final String version = DJIVisionApplication.getProductInstance().getFirmwarePackageVersion();
    ...
    private void refreshSDKRelativeUI() {
        ...
        BaseProduct mProduct = DJIVisionApplication.getProductInstance();
